...
//
import '../Styles(1)/HeaderCss.css';
import Adroll_Header_Logo from '../img(1)/adroll-logo-2x.png';
import RollWorks_Header_Logo from '../img(1)/rollworks-logo-2x.png';
import RollWorks_Off_image from '../img(1)/rollworks-logo-grayscale-2x.png';
import USA_Flag_Image from '../img(1)/au.png';
    ...
    <nav id='site-switcher'>
        <div className='Logos-Div'>
            <ul>
                ...
                <li id='Adroll_On_Logo_li'><a className='logslinks' href="#readmore" ><img src={Adroll_Header_Logo} alt='adroll' /></a></li>
                <li id='Adroll_Off_Logo_li'><a  className='logslinks' href="#readmore" ><img src={Adroll_Header_Logo} alt='adroll' /></a></li>
